...
lng_canada <- vgrid2
head(lng_canada)
saveRDS(lng_canada, file='tests/vessels_lng_canada_8_14knots.RData')

# Save as pkg data
lng_canada <- readRDS(file='data-raw/vessels_lng_canada_8_14knots.RData')
usethis::use_data(lng_canada, overwrite = TRUE)
