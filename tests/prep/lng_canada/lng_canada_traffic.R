...
plotKFS()
points(tanker_route)
abline(h=53.38) # douglas
abline(h=53.32) # wright
abline(h=53.23) # lewis
abline(v=-129.55) # lewis

# Squally
tanker_route$heel <- 8
tanker_route$product <- 7

# Lewis
tanker_route$heel[tanker_route$y >= 53.23] <- 8
tanker_route$product[tanker_route$y >= 53.23] <- 7
...
# Wright channel
tanker_route$heel[tanker_route$y >= 53.32] <- 8
tanker_route$product[tanker_route$y >= 53.32] <- 6

# Douglas channel
tanker_route$heel[tanker_route$y >= 53.38] <- 8
tanker_route$product[tanker_route$y >= 53.38] <- 8

# Nepean / Principe
tanker_route$heel[tanker_route$x <= -129.55] <- 10
tanker_route$product[tanker_route$x <= -129.55] <- 10
...
lng_canada <- vgrid2
head(lng_canada)
saveRDS(lng_canada, file='tests/vessels_lng_canada.RData')
